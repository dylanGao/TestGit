...
$md5file = 'main.js';
// $content = file_get_contents($file);
$md5data = file_get_contents($md5file);
$md5str = md5($md5data);
echo  "#main.js md5 data:\n" .$md5str. "\n";

echo "==========\n\n";

$md5crypted = '';
for($i=0; $i<strlen($md5str); $i+=117){
	$src = substr($md5str, $i, 117);
	$ret = openssl_private_encrypt($src, $out, $private_key);
	$md5crypted .= $out;
}
echo "#MD5 enc by private:\n" . base64_encode($md5crypted) . "\n";
